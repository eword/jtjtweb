<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/manage/Views/Shared/Manage_Areas.Master"
    Inherits="System.Web.Mvc.ViewPage<eulei.shop.Models.TB_Article>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Edit", "Article", new { @area = "manage" }, FormMethod.Post, new { @id = "postForm" }))
       { %>
    ...
    <table>
        ...
        <tr class="lbgalt">
            ...
            <td class="editor-field ">
                <%:Html.TextBox("ArticleSendDate",Model.ArticleSendDate.ToShortDateString(), new { @class = "datecss" })%>
            </td>
            <td class="editor-label">
                浏览数：
            </td>
            <td class="editor-field">
                <%:Html.TextBoxFor(m => m.ArticleClickCount,new { @class = "count" })%>
            </td>
        </tr>
        <tr class="lbg">
            <td colspan="4">
    ...
    <% } %>
    <div>
        <a href="<%= ViewData["_returnUrl"].ToString() %>">返回列表</a>
    </div>
        ...
        $(function () {
            ...
            $("#postForm").validate({
                ...
                rules: {
                    ...
                    ArticleClickCount: { required: true, digits: true }
                },
                messages: {
                    ArticleTitle: '请填写标题！',
