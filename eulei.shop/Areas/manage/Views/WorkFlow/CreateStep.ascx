...
<script type="text/javascript">
    $(function () {
        $("#CreateStepPost").validate({
            ...
            onclick: false,
            rules: {
                FlowTemplateStatusID: { required: true, digits: true, max: 98, min: 2 },
                FlowTemplateStatusDesp: { required: true },
            ...
            messages: {
                FlowTemplateStatusID: { required: "步骤序号不许为空！", digits: "步骤序号必须输入整数！", max: "步骤序号不能大于98", min: "步骤序号不能小于2" },
                FlowTemplateStatusDesp: '请填写步骤描述！',
