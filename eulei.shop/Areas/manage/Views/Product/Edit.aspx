<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/manage/Views/Shared/Manage_Areas.Master" Inherits="System.Web.Mvc.ViewPage<eulei.shop.Models.TB_Merchandise>" %>
...
<script type="text/javascript" src="<%: Url.Content("~/Scripts/jquery.validate.min.js") %>"></script>
    ...
    <% using (Html.BeginForm("Edit", "Product", new { @area = "manage" }, FormMethod.Post, new { @id = "postForm" }))
       { %>
    ...
    <table>
        ...
        <tr class="lbgalt">
            ...
            <td class="editor-field">
                <%:Html.TextBox("MerchandiseBeginDate", Model.MerchandiseBeginDate.ToShortDateString(), new { @class = "datecss" })%>
            </td>
        </tr>
        <tr class="lbg">
            <td class="editor-label">
        ...
        <tr class="lbgalt">
            ...
            <td class="editor-field ">
                <%:Html.TextBox("MerchandiseDate", Model.MerchandiseDate.ToShortDateString(), new { @class = "datecss" })%>
            </td>
            <td class="editor-label">
                浏览数：
            </td>
            <td class="editor-field">                                
            <%:Html.TextBoxFor(m => m.MerchandiseClickCount, new { @class = "count" })%>     
            </td>
        </tr>
        <tr class="lbg">
            <td colspan="4">
