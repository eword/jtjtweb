<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/manage/Views/Shared/Manage_Areas.Master"
    Inherits="System.Web.Mvc.ViewPage<eulei.shop.Models.TB_Advertisement>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <% using (Html.BeginForm("Create", "WordAD", new { @area = "manage" }, FormMethod.Post, new { @id = "postForm" }))
       { %>
    ...
    <table>
        ...
        <tr class="lbgalt">
            ...
            <td class="editor-field">
                <%:Html.TextBox("AdvertisementRemindDate", DateTime.Now.ToShortDateString(), new { @class = "datecss" })%>
            </td>
        </tr>
        <tr class="lbg">
            <td class="editor-label">
