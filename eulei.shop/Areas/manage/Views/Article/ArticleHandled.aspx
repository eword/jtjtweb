<%@ Page Title="" Language="C#" MasterPageFile="~/Areas/manage/Views/Shared/Manage_Areas.Master"
    Inherits="System.Web.Mvc.ViewPage<IEnumerable<eulei.shop.Models.VW_SA_ArticleHandled>>" %>
                    ...
                    <%:item.ArticleTitle %>
                            ...
                            <td class="tl">
                                ...
                                <%if (item.ArticleAuthor.Equals(User.Identity.Name))
                                  { %>
                                <%: Html.ActionLink("申请撤回", "Withdraw", new { @id = item.ArticleID, @_returnUrl = Request.Url.PathAndQuery }, new { @class = "Withdraw detailslink line-height24" })%>
                                <%} %>
                                <%break; %>
