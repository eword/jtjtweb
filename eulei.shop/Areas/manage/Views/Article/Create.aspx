...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
 <script type="text/javascript" src="<%: Url.Content("~/Scripts/jquery.validate.min.js") %>"></script>
    ...
    <script type="text/javascript" src="<%: Url.Content("~/Libs/ligerUI/js/plugins/ligerTree.js") %>"></script>
                    ...
                    <% using (Html.BeginForm("Create", "Article",new{@area="manage"},FormMethod.Post, new { @id = "postForm" }))
                       { %>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#ArticleTypeIDCombobox").ligerComboBox({
                ...
                selectBoxWidth: 200,
                selectBoxHeight: 200,
                textField: 'textcontent', valueField: 'id', valueFieldID: 'ArticleTypeID', treeLeafOnly: true, hideOnLoseFocus: true,
