...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#tb_send").bind("click", function (event) {
                $("#postForm").first().attr("action", "/manage/article/Auditing/<%=Model.ArticleID%>").submit();
                        });
    ...
    <table>
        <tr>
            <td><%:Html.Hidden("_returnUrl", ViewData["_returnUrl"].ToString())%>                
                <input type="submit" id="tb_send" value="发布"  class="btnsubmit  rmargin15" />
